...
class TradeLogger:
    ...
    def log_trade(self, trade: dict[str, Any]) -> dict[str, Any]:
        ...
        record = {
            ...
            "slippage_pct": float(trade.get("slippage_pct") or 0.0) if trade.get("slippage_pct") is not None else "",
            "gross_pnl": float(trade.get("gross_pnl") or 0.0) if trade.get("gross_pnl") is not None else "",
